...
MAG_dir = Path(r'/Users/sr2/OneDrive - University College London/PhD/Research/Missions/SWARM/in-flight data/MAG/April-16')
path = r'/Users/sr2/OneDrive - University College London/PhD/Research/Missions/SWARM/Non-Flight Data/Analysis/Apr-22/data/extraction/mag/'
    ...
    def openMAG(self, dire):
        ...
        try:
            for f in cdf_files:
                ...
                alpha = cdf.varget("alpha") #solar inc angle, rot about y axis (sc frame)
                beta = cdf.varget("beta") #solar inc angle, angle to y axis
            
                #extract scalars
                cdf_scal = pd.DataFrame({'datetime':utc,'lat':lat,'long':lon, 'alt':alt, 'f':f,
                        "f_err":f_err, 'alpha':alpha, 'beta':beta})
